...
func (r *Reporter) Init() {
	...
	//fmt.Println("bbnLatestBlockHeight", bbnLatestBlockHeight)
	//fmt.Println("bbnBaseHeight", bbnBaseHeight)
	//fmt.Println("r.babylonClient.ConfirmationDepth", r.btcConfirmationDepth)
	//
	...
	//}
	//
	//fmt.Println("consistencyCheckHeight", consistencyCheckHeight)
	//
...
func (r *Reporter) initBTCCache() (*types.BTCCache, error) {
	...
	// hardcoding the stopHeight to avoid syncing from beginning
	stopHeight = 2375440

	fmt.Println("stopHeight", stopHeight)
	fmt.Println("bbnBaseHeight", bbnBaseHeight)
	fmt.Println("bbnLatestBlockHeight", bbnLatestBlockHeight)
	fmt.Println("r.btcConfirmationDepth", r.btcConfirmationDepth)
	fmt.Println("r.checkpointFinalizationTimeout", r.checkpointFinalizationTimeout)
